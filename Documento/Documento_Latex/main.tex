...
\author{
    Jefry Nicolas Chicaiza - \url{jefryn@unicauca.edu.co}\\
    Jose Nicolas Zambrano - \url{jnzambranob@unicauca.edu.co}
}
\date{}
...
\section*{Introducción}
    La elaboración de este documento se realiza para comprender los conceptos básicos de 
    las Series de Fourier apartir de una función de tipo Diente de Sierra, 
    ...
    \begin{enumerate}
        \item Contextualizar. En esta parte deben indicar por qué y el para qué de su informe 
